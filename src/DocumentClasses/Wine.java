...
public class Wine {
    ...
    public double free_sulfur_dioxide = 0;
    public double total_sulfur_dioxide = 0;
    ...
    public Wine(String[] values){
        ...
        this.free_sulfur_dioxide = Double.parseDouble(values[5]);
        this.total_sulfur_dioxide = Double.parseDouble(values[6]);
    ...
    public String toString(){
        ...
        res += ", free_sulfur_dioxide: " + Double.toString(free_sulfur_dioxide);
        res += ", total_sulfur_dioxide: " + Double.toString(total_sulfur_dioxide);
